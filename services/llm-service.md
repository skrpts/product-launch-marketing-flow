...
id: llm-service
title: LLM Service
description: "Language model service providing launch planning and go-to-market messaging capabilities"
tags: [Production]
connections: []
metadata:
  serviceType: llm
...
Provides access to a large language model for launch planning and go-to-market messaging. Used by all skills in this skrpt.
